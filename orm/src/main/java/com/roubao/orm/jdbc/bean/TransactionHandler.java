...
public class TransactionHandler {
    ...
    public static void rollbackTransaction(DataSourceTransactionManager dataSourceTransactionManager,
        TransactionStatus status) {
        dataSourceTransactionManager.rollback(status);
    }

    public static void commitTransaction(DataSourceTransactionManager dataSourceTransactionManager,
        TransactionStatus status) {
